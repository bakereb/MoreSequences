...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 1:  200 slices, thin black lines on a yellow circle.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.fill_color = 'yellow'
    pizza(window, circle, 200, 'black', 0)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    title2 = 'POLYGON test 3: 4 segments, black lines on lime green circle'
    window = rg.RoseWindow(550, 400, title2)
